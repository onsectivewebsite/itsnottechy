        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <Reveal>
            ...
            <h2 className="mt-2 max-w-2xl font-display text-4xl font-semibold tracking-tight text-white md:text-6xl">
              Every digital marketing lever, under one roof.
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
      ...
      <section className="section">
        <Reveal>
          ...
          <h2 className="mt-2 max-w-3xl font-display text-4xl font-semibold tracking-tight text-white md:text-6xl">
            Industry-fluent. Outcome-obsessed.
          </h2>
        </Reveal>
          ...
          {industries.slice(0, 8).map((i, idx) => (
            <Reveal key={i.slug} delay={idx * 0.04}>
              ...
              >
                ...
                <span className="mt-4 inline-flex items-center gap-1 text-xs font-medium text-brand">
                  Explore playbook <ArrowUpRight className="h-3.5 w-3.5" />
                </span>
              </Link>
            </Reveal>
          ))}
      ...
      <section className="section">
        <div className="flex items-end justify-between">
          <Reveal>
            ...
            <h2 className="mt-2 max-w-3xl font-display text-4xl font-semibold tracking-tight text-white md:text-6xl">
              Fresh thinking, shipped weekly.
            </h2>
          </Reveal>
          <Link
            href="/blog"
            className="hidden text-sm text-brand hover:underline md:inline"
          >
          ...
          {latestPosts.map((p, i) => (
            <Reveal key={p.slug} delay={i * 0.05}>
              ...
              >
                ...
                <h3 className="mt-4 line-clamp-2 font-display text-xl font-semibold text-white">
                  {p.title}
                </h3>
